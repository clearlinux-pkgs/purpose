...
Source0  : https://download.kde.org/stable/frameworks/5.67/purpose-5.67.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.67/purpose-5.67.0.tar.xz.sig
...
%prep
%setup -q -n purpose-5.67.0
cd %{_builddir}/purpose-5.67.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1581383091
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/purpose-5.67.0/COPYING.LIB %{buildroot}/usr/share/package-licenses/purpose/01a6b4bf79aca9b556822601186afab86e8c4fbf
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5Purpose.so.5.67.0
/usr/lib64/libKF5PurposeWidgets.so.5
/usr/lib64/libKF5PurposeWidgets.so.5.67.0
/usr/lib64/libPhabricatorHelpers.so.5
/usr/lib64/libPhabricatorHelpers.so.5.67.0
/usr/lib64/libReviewboardHelpers.so.5
/usr/lib64/libReviewboardHelpers.so.5.67.0
