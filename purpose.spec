...
Version  : 6.9.0
Release  : 87
URL      : https://download.kde.org/stable/frameworks/6.9/purpose-6.9.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.9/purpose-6.9.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.9/purpose-6.9.0.tar.xz.sig
...
%setup -q -n purpose-6.9.0
cd %{_builddir}/purpose-6.9.0
pushd ..
cp -a purpose-6.9.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735324119
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6Purpose.so.6.9.0
/V3/usr/lib64/libKF6PurposeWidgets.so.6.9.0
...
/usr/lib64/libKF6Purpose.so.6.9.0
/usr/lib64/libKF6PurposeWidgets.so.6
/usr/lib64/libKF6PurposeWidgets.so.6.9.0
