...
Version  : 5.83.0
Release  : 37
URL      : https://download.kde.org/stable/frameworks/5.83/purpose-5.83.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.83/purpose-5.83.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.83/purpose-5.83.0.tar.xz.sig
...
%prep
%setup -q -n purpose-5.83.0
cd %{_builddir}/purpose-5.83.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1623714207
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/purpose-5.83.0/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/purpose/e712eadfab0d2357c0f50f599ef35ee0d87534cb
cp %{_builddir}/purpose-5.83.0/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/purpose/20079e8f79713dce80ab09774505773c926afa2a
cp %{_builddir}/purpose-5.83.0/LICENSES/LGPL-2.1-or-later.txt %{buildroot}/usr/share/package-licenses/purpose/6f1f675aa5f6a2bbaa573b8343044b166be28399
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5Purpose.so.5.83.0
/usr/lib64/libKF5PurposeWidgets.so.5
/usr/lib64/libKF5PurposeWidgets.so.5.83.0
/usr/lib64/libPhabricatorHelpers.so.5
/usr/lib64/libPhabricatorHelpers.so.5.83.0
/usr/lib64/libReviewboardHelpers.so.5
/usr/lib64/libReviewboardHelpers.so.5.83.0
