...
Version  : 5.55.0
Release  : 10
URL      : https://download.kde.org/stable/frameworks/5.55/purpose-5.55.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.55/purpose-5.55.0.tar.xz
Source99 : https://download.kde.org/stable/frameworks/5.55/purpose-5.55.0.tar.xz.sig
...
export LANG=C
export SOURCE_DATE_EPOCH=1549767068
mkdir -p clr-build
pushd clr-build
%cmake ..
...
/usr/lib64/libKF5Purpose.so.5.55.0
/usr/lib64/libKF5PurposeWidgets.so.5
/usr/lib64/libKF5PurposeWidgets.so.5.55.0
/usr/lib64/libPhabricatorHelpers.so.5
/usr/lib64/libPhabricatorHelpers.so.5.55.0
/usr/lib64/libReviewboardHelpers.so.5
/usr/lib64/libReviewboardHelpers.so.5.55.0
