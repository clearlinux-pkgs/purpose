...
Version  : 5.92.0
Release  : 45
URL      : https://download.kde.org/stable/frameworks/5.92/purpose-5.92.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.92/purpose-5.92.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.92/purpose-5.92.0.tar.xz.sig
...
%prep
%setup -q -n purpose-5.92.0
cd %{_builddir}/purpose-5.92.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1647636445
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/purpose-5.92.0/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/purpose/82da472f6d00dc5f0a651f33ebb320aa9c7b08d0
cp %{_builddir}/purpose-5.92.0/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/purpose/e712eadfab0d2357c0f50f599ef35ee0d87534cb
cp %{_builddir}/purpose-5.92.0/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/purpose/20079e8f79713dce80ab09774505773c926afa2a
cp %{_builddir}/purpose-5.92.0/LICENSES/LGPL-2.1-or-later.txt %{buildroot}/usr/share/package-licenses/purpose/6f1f675aa5f6a2bbaa573b8343044b166be28399
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5Purpose.so.5.92.0
/usr/lib64/libKF5PurposeWidgets.so.5
/usr/lib64/libKF5PurposeWidgets.so.5.92.0
/usr/lib64/libPhabricatorHelpers.so.5
/usr/lib64/libPhabricatorHelpers.so.5.92.0
/usr/lib64/libReviewboardHelpers.so.5
/usr/lib64/libReviewboardHelpers.so.5.92.0
...
%files locales -f libpurpose_quick.lang -f libpurpose_widgets.lang -f purpose-fileitemaction.lang -f purpose_barcode.lang -f purpose_bluetooth.lang -f purpose_email.lang -f purpose_imgur.lang -f purpose_kdeconnect.lang -f purpose_kdeconnectsms.lang -f purpose_ktp-sendfile.lang -f purpose_nextcloud.lang -f purpose_pastebin.lang -f purpose_phabricator.lang -f purpose_reviewboard.lang -f purpose_saveas.lang -f purpose_youtube.lang
%defattr(-,root,root,-)
