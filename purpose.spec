...
Version  : 5.97.0
Release  : 50
URL      : https://download.kde.org/stable/frameworks/5.97/purpose-5.97.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.97/purpose-5.97.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.97/purpose-5.97.0.tar.xz.sig
...
%prep
%setup -q -n purpose-5.97.0
cd %{_builddir}/purpose-5.97.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1660578243
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5Purpose.so.5.97.0
/usr/lib64/libKF5PurposeWidgets.so.5
/usr/lib64/libKF5PurposeWidgets.so.5.97.0
/usr/lib64/libPhabricatorHelpers.so.5
/usr/lib64/libPhabricatorHelpers.so.5.97.0
/usr/lib64/libReviewboardHelpers.so.5
/usr/lib64/libReviewboardHelpers.so.5.97.0
