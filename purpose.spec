...
Version  : 6.2.0
Release  : 78
URL      : https://download.kde.org/stable/frameworks/6.2/purpose-6.2.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.2/purpose-6.2.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.2/purpose-6.2.0.tar.xz.sig
...
%setup -q -n purpose-6.2.0
cd %{_builddir}/purpose-6.2.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1715653092
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6Purpose.so.6.2.0
/V3/usr/lib64/libKF6PurposeWidgets.so.6.2.0
...
/usr/lib64/libKF6Purpose.so.6.2.0
/usr/lib64/libKF6PurposeWidgets.so.6
/usr/lib64/libKF6PurposeWidgets.so.6.2.0
