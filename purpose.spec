...
Version  : 6.1.0
Release  : 76
URL      : https://download.kde.org/stable/frameworks/6.1/purpose-6.1.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.1/purpose-6.1.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.1/purpose-6.1.0.tar.xz.sig
...
%setup -q -n purpose-6.1.0
cd %{_builddir}/purpose-6.1.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713115779
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6Purpose.so.6.1.0
/V3/usr/lib64/libKF6PurposeWidgets.so.6.1.0
...
/usr/lib64/libKF6Purpose.so.6.1.0
/usr/lib64/libKF6PurposeWidgets.so.6
/usr/lib64/libKF6PurposeWidgets.so.6.1.0
