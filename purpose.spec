...
Version  : 5.63.0
Release  : 20
URL      : https://download.kde.org/stable/frameworks/5.63/purpose-5.63.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.63/purpose-5.63.0.tar.xz
Source1 : https://download.kde.org/stable/frameworks/5.63/purpose-5.63.0.tar.xz.sig
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1570983328
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5Purpose.so.5.63.0
/usr/lib64/libKF5PurposeWidgets.so.5
/usr/lib64/libKF5PurposeWidgets.so.5.63.0
/usr/lib64/libPhabricatorHelpers.so.5
/usr/lib64/libPhabricatorHelpers.so.5.63.0
/usr/lib64/libReviewboardHelpers.so.5
/usr/lib64/libReviewboardHelpers.so.5.63.0
